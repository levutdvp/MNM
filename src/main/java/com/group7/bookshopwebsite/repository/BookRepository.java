...
public interface BookRepository extends JpaRepository<Book, Long> {
	...
	Page<Book> findByCategoryIdAndTitleContainingOrderBySalePriceDesc(Long categoryId, String keyword,
			Pageable pageable);

	Page<Book> findByCategoryIdAndTitleContainingOrderBySalePriceAsc(Long categoryId, String keyword,
			Pageable pageable);

	Page<Book> findByCategoryIdAndTitleContainingOrderByCreatedAtAsc(Long categoryId, String keyword,
			Pageable pageable);
